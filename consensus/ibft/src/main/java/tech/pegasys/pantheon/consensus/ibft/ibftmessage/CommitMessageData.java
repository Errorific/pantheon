...
public class CommitMessageData extends AbstractIbftMessageData {
  ...
  public static CommitMessageData fromMessage(final MessageData message) {
    return fromMessage(message, MESSAGE_CODE, CommitMessageData.class, CommitMessageData::new);
  }
