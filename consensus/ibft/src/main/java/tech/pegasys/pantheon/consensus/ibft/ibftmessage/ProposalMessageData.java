...
public class ProposalMessageData extends AbstractIbftMessageData {
  ...
  public static ProposalMessageData fromMessage(final MessageData message) {
    return fromMessage(message, MESSAGE_CODE, ProposalMessageData.class, ProposalMessageData::new);
  }
